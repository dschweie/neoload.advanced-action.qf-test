...
/**
 *  \brief      Verwaltungs-Klasse für die Advanced Action zum Stoppen eines QF-Test-Daemon
 *
 ...
 */
public class QFTestStopAction extends AbstractQFTestAction
{
  public static final String TYPE = "QF-Test-Daemon-Stop";
   ...
   */
  private static final String BUNDLE_NAME = "org.dschweie.neoload.advancedactions.qf_test.qf-test-daemon-stop";

  /**
   *  \brief  Standardkonstruktor der Klasse
   */
  public QFTestStopAction()
  {
    super(BUNDLE_NAME);
  }
  ...
  {
    return QFTestStopActionEngine.class;
  }
